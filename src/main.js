...
function initializeDashboard() {
	...
	buttonPopoutChat.forEach(button => {
		button.addEventListener('click', () => {
			...
			const assistantCard = document.querySelector('.assistant-container');
			if (assistantCard) {
				assistantCard.classList.toggle('visible');
				document.querySelector('.assistant-detached').classList.toggle('visible');
			}
		});
	});
}
